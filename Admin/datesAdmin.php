...
<body>
        ...
        <td>
          <table>
            <tr>
              ...
              <td>
                <p style="font-size:30px;">Gestion des "époques/dates"</p>
              </td>
            </tr>
        </table>
        </td>
  ...
  <div class="row">
    <div class="col-sm">
      ...
      <button class="btn btn-dark m-4" disabled>Gestion des "époques"/dates</button></br>
